...
go get \[github.com/yourusername/go-tinyusdz\](https://github.com/yourusername/go-tinyusdz)
...
import (
	"fmt"
	"log"
	"\[github.com/yourusername/go-tinyusdz\](https://github.com/yourusername/go-tinyusdz)"
)
...
1. **Clone the Repo**:
   git clone \[https://github.com/yourusername/go-tinyusdz.git\](https://github.com/yourusername/go-tinyusdz.git)
   cd go-tinyusdz
...
1. **tinyusdz\_wrapper.go (Generated)**:
   * Created by cmd/gen.
   * Contains raw Cgo functions (e.g., C.c\_tinyusd\_stage\_new).
